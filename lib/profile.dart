...
import 'package:wender1/widgets/avatar_card.dart';
import 'package:wender1/widgets/setting_title.dart'; // นำเข้าไฟล์ setting_title.dart ที่มีคลาส SettingTile
    ...
    return Scaffold(
      bottomNavigationBar: CurvedNavigationBar(
        ...
        items: <Widget>[
          ...
          Icon(Icons.person, size: 26, color: Colors.white), // เพิ่มไอคอน 'Profile' ที่นี่
                ...
                children: [
                  ...
                  Column(
                    children: List.generate(
                      settings.length,
                      (index) => SettingTile(setting: settings[index]), // เรียกใช้ SettingTile จากไฟล์ setting_title.dart
                    ),
                  ),
                  const SizedBox(height: 10),
                  const Divider(),
